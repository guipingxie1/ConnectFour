...
public class Board
{
    ...
    /**
     * Constructor for the Board class Initializes the board to all empty characters
     */
    public Board()
    {
     ...
     * 
     * @param pos
     *            : The position the player wants to put their piece (0 - 6), x-value
     * @param player
     *            : The player, X or Y
    ...
    /**
     * Clears the board (sets everything to the space character) Called if the user wants to play
     * again
     */
    ...
    /**
     * Called when a player undoes a move Clears the piece at the provided coordinates
     * 
     * @param pos
    ...
    /**
     * Function to check whether a player has won or not Position and player passed in so we do not
    ...
    /**
     * Function to check whether a player has won or not Position and player passed in so we do not
     * have to check everything Helper for checkWin, checks the horizontal direction
     * 
     * @param pos
     *            : The position the player put their piece (0 - 6), x-value
     * @param idx
    ...
    /**
     * Function to check whether a player has won or not Position and player passed in so we do not
     * have to check everything Helper for checkWin, checks the vertical direction
     * 
     * @param pos
     *            : The position the player put their piece (0 - 6), x-value
     * @param idx
    ...
    /**
     * Function to check whether a player has won or not Position and player passed in so we do not
     * have to check everything Helper for checkWin, checks the right diagonal direction: /
     * 
     * @param pos
     *            : The position the player put their piece (0 - 6), x-value
     * @param idx
    ...
    /**
     * Function to check whether a player has won or not Position and player passed in so we do not
     * have to check everything Helper for checkWin, checks the left diagonal direction: \
     * 
     * @param pos
     *            : The position the player put their piece (0 - 6), x-value
     * @param idx
