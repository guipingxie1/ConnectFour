...
public class Interface
{
    ...
    public Interface()
    {
        ...
        frame.setSize(BOARD_WIDTH * SQUARE_SIZE + 2 * BORDER_WIDTH + OFFSET + SIDE_WIDTH, BOARD_HEIGHT
                * SQUARE_SIZE + 2 * BORDER_WIDTH + BUTTON_SIZE + OFFSET);
    ...
    private void initWindow()
    {
        ...
        window.setPreferredSize(new Dimension(BOARD_WIDTH * SQUARE_SIZE + 2 * BORDER_WIDTH + OFFSET
                + SIDE_WIDTH, BOARD_HEIGHT * SQUARE_SIZE + 2 * BORDER_WIDTH + BUTTON_SIZE + 3 * OFFSET));
    ...
    private void initMainBoard()
    {
        ...
        mainBoard.setPreferredSize(new Dimension(BOARD_WIDTH * SQUARE_SIZE + 2 * BORDER_WIDTH, BOARD_HEIGHT
                * SQUARE_SIZE + 2 * BORDER_WIDTH + BUTTON_SIZE + OFFSET));
        mainBoard.setMinimumSize(new Dimension(BOARD_WIDTH * SQUARE_SIZE + 2 * BORDER_WIDTH, BOARD_HEIGHT
                * SQUARE_SIZE + 2 * BORDER_WIDTH + BUTTON_SIZE + OFFSET));
    ...
    private void initSideButtons()
    {
        ...
        sideButtons.setPreferredSize(new Dimension(SIDE_WIDTH - OFFSET, BOARD_HEIGHT * SQUARE_SIZE + 2
                * BORDER_WIDTH + BUTTON_SIZE + OFFSET));
        sideButtons.setMinimumSize(new Dimension(SIDE_WIDTH - OFFSET, BOARD_HEIGHT * SQUARE_SIZE + 2
                * BORDER_WIDTH + BUTTON_SIZE + OFFSET));
        ...
        for (int i = 0; i < 2 * BOARD_HEIGHT; ++i)
        {
            ...
            sideButtonPanels[i].setPreferredSize(new Dimension(SIDE_WIDTH - OFFSET, SQUARE_SIZE / 2));
            sideButtonPanels[i].setMinimumSize(new Dimension(SIDE_WIDTH - OFFSET, SQUARE_SIZE / 2));
    ...
    private void initBoard()
    {
        ...
        for (int i = 0; i < BOARD_HEIGHT; ++i)
        {
            for (int j = 0; j < BOARD_WIDTH; ++j)
            {
                ...
                /*
                 * JLabel label1 = new JLabel(i + " " + j); boardPanels[i][j].add(label1);
                 */
    ...
    /**
     * Called when a player makes a move Changes the piecePanels array to the corresponding players
     * color
     * 
     * @param pos
    ...
    /**
     * Called when a player undoes a move Changes the piecePanels array to white
     * 
     * @param pos
     *            : The position the player put their piece (0 - 6), x-value
     * @param idx
    ...
    {
        boardPanels[pos][idx].setBorder(BorderFactory.createLineBorder(Color.GREEN, GRID_WIDTH));
    }

    /**
     * Returns whether the game is tied or not Done by checking if every button is disabled or not
     * 
    ...
    /**
     * Resets the background of the board to white Called if the user wants to play again
     */
